...
public class PopupStorePopularController {
    ...
    public ResponseEntity<Page<PopupStoreResponseDTO>> getTopLikedPopupStores(Pageable pageable) {
        Page<PopupStoreResponseDTO> popupStores = popupStorePopularService.getTopLikedPopupStores(pageable);
